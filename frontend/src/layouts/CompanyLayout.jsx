...
export default function CompanyLayout() {
  ...
  return (
    <div className="stitch-page relative bg-surface text-on-surface font-body-md text-body-md flex h-screen overflow-hidden">
      <NetworkBackground color="#3b82f6" particleCount={60} maxDist={130} />
