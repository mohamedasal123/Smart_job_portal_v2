    ...
    <article className="bg-surface-container-lowest rounded-xl p-stack-lg border border-outline-variant shadow-ambient">
      <div className="flex items-start gap-stack-md">
        ...
        <div className="flex-1">
          ...
          <p className="font-body-md text-body-md text-on-surface-variant">{applicant.title} · {t('companyFlow.applicantProfile.yearsLabel', { years: applicant.yearsExperience })}</p>
        </div>
      ...
      <div className="mt-stack-md flex items-center justify-between gap-stack-md">
        ...
        <span className="font-body-sm text-body-sm text-on-surface-variant">{t('dashboardComponents.common.applied', { date: applicant.appliedAt })}</span>
      </div>
